...
def upload():
    ...
    for file in files:
        ...
        uploaded_files.append(
            {"type": file_type, "url": file_url, "content_type": file.content_type}
        )
    ...
    if len(uploaded_files) > 1:
        socketio.emit(
            "update_content",
            {"type": "multiple_files", "files": uploaded_files},
            room="page2_users",
        )
    else:
        socketio.emit(
            "update_content",
            {"type": uploaded_files[0]["type"], "file_url": uploaded_files[0]["url"]},
            room="page2_users",
        )
